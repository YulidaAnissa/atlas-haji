...
export const ACCESS_TOKEN_STORAGE = 'blue';
export const ACCESS_TOKEN_EXPIRE_STORAGE = 'purple';
export const PROFILE_FULLNAME_STORAGE = 'red';
export const PROFILE_ID_STORAGE = 'yellow';
...
// export const ACCESS_TOKEN_EXPIRE_STORAGE = 'white';
// export const ACCESS_TOKEN_EXPIRE_STORAGE = 'brown';